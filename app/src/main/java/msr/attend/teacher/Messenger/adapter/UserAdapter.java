...
import msr.attend.teacher.Messenger.MessageActivity;
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                   ...
                   if (userPref.getTeacherId() != null && chat != null) {
                        if (chat.getReceiver().equals(userPref.getTeacherId()) && chat.getSender().equals(userid) ||
                                chat.getReceiver().equals(userid) && chat.getSender().equals(userPref.getTeacherId())) {
